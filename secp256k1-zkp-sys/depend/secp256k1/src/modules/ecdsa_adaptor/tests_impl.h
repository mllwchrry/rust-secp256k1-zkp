...
static void dleq_tests(void) {
    ...
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(sk32, sizeof(sk32));
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(gen2_33, sizeof(gen2_33));
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(p1_33, sizeof(p1_33));
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(p2_33, sizeof(p2_33));
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(aux_rand, sizeof(aux_rand));
...
static void rand_flip_bit(unsigned char *array, size_t n) {
    array[rustsecp256k1zkp_v0_11_0_testrand_int(n)] ^= 1 << rustsecp256k1zkp_v0_11_0_testrand_int(8);
}
...
static void run_nonce_function_ecdsa_adaptor_tests(void) {
    ...
    * state. */
    ...
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(key, sizeof(key));
    ...
    for (i = 0; i < COUNT; i++) {
        ...
        uint32_t offset = rustsecp256k1zkp_v0_11_0_testrand_int(algolen - 1);
...
static void test_ecdsa_adaptor_api(void) {
    ...
    rustsecp256k1zkp_v0_11_0_testrand256(deckey);
...
static void multi_hop_lock_tests(void) {
    ...
    rustsecp256k1zkp_v0_11_0_testrand256(seckey_a);
    rustsecp256k1zkp_v0_11_0_testrand256(seckey_b);
    ...
    /* Carol setup */
    /* Proof of payment */
    rustsecp256k1zkp_v0_11_0_testrand256(pop);
    CHECK(rustsecp256k1zkp_v0_11_0_ec_pubkey_create(CTX, &pubkey_pop, pop));

    /* Alice setup */
    rustsecp256k1zkp_v0_11_0_testrand256(tx_ab);
    rand_scalar(&t1);
    rand_scalar(&t2);
    ...
    rustsecp256k1zkp_v0_11_0_testrand256(tx_bc);
