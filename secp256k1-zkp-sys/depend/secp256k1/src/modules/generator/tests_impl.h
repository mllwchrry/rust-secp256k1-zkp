...
static void test_generator_api(void) {
    ...
    rustsecp256k1zkp_v0_11_0_testrand256(key);
    rustsecp256k1zkp_v0_11_0_testrand256(blind);
...
static void test_pedersen_api(void) {
    ...
    uint64_t val = rustsecp256k1zkp_v0_11_0_testrand32();
...
static void test_pedersen(void) {
    ...
    int outputs;
    int total;
    inputs = (rustsecp256k1zkp_v0_11_0_testrand32() & 7) + 1;
    outputs = (rustsecp256k1zkp_v0_11_0_testrand32() & 7) + 2;
    ...
    totalv = 0;
    for (i = 0; i < inputs; i++) {
        values[i] = rustsecp256k1zkp_v0_11_0_testrandi64(0, INT64_MAX - totalv);
        totalv += values[i];
    }
    for (i = 0; i < outputs - 1; i++) {
        values[i + inputs] = rustsecp256k1zkp_v0_11_0_testrandi64(0, totalv);
