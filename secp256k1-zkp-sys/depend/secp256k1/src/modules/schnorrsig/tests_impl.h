...
static void run_nonce_function_bip340_tests(void) {
    ...
    * state. */
    ...
    rustsecp256k1zkp_v0_11_0_testrand256(pk);
    rustsecp256k1zkp_v0_11_0_testrand256(aux_rand);
    ...
    /* Other algo is fine */
    rustsecp256k1zkp_v0_11_0_testrand_bytes_test(algo, algolen);
    CHECK(nonce_function_bip340(nonce, msg, msglen, key, pk, algo, algolen, NULL) == 1);

    for (i = 0; i < COUNT; i++) {
        unsigned char nonce2[32];
        uint32_t offset = rustsecp256k1zkp_v0_11_0_testrand_int(msglen - 1);
        ...
        offset = rustsecp256k1zkp_v0_11_0_testrand_int(algolen - 1);
...
static void test_schnorrsig_api(void) {
    ...
    rustsecp256k1zkp_v0_11_0_testrand256(sk1);
    rustsecp256k1zkp_v0_11_0_testrand256(sk2);
    rustsecp256k1zkp_v0_11_0_testrand256(sk3);
    rustsecp256k1zkp_v0_11_0_testrand256(msg);
...
static void test_schnorrsig_sign_verify(void) {
    ...
    for (i = 0; i < N_SIGS; i++) {
        rustsecp256k1zkp_v0_11_0_testrand256(msg[i]);
...

    {
        ...
        size_t sig_idx = rustsecp256k1zkp_v0_11_0_testrand_int(N_SIGS);
        size_t byte_idx = rustsecp256k1zkp_v0_11_0_testrand_bits(5);
        unsigned char xorbyte = rustsecp256k1zkp_v0_11_0_testrand_int(254)+1;
        sig[sig_idx][byte_idx] ^= xorbyte;
        CHECK(!rustsecp256k1zkp_v0_11_0_schnorrsig_verify(CTX, sig[sig_idx], msg[sig_idx], sizeof(msg[sig_idx]), &pk));
        sig[sig_idx][byte_idx] ^= xorbyte;

        byte_idx = rustsecp256k1zkp_v0_11_0_testrand_bits(5);
...

    {
        ...
        uint32_t msglen  = rustsecp256k1zkp_v0_11_0_testrand_int(sizeof(msg_large));
        for (i = 0; i < sizeof(msg_large); i += 32) {
            rustsecp256k1zkp_v0_11_0_testrand256(&msg_large[i]);
        }
