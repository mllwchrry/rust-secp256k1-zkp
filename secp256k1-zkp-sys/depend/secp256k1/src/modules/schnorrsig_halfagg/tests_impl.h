...
void test_schnorrsig_aggregate_input_helper(rustsecp256k1zkp_v0_11_0_xonly_pubkey *pubkeys, unsigned char *msgs32, unsigned char *sigs64, size_t n) {
    ...
    for (i = 0; i < n; ++i) {
        ...
        rustsecp256k1zkp_v0_11_0_testrand256(&msgs32[i*32]);
...
void test_schnorrsig_aggregate(void) {
    ...
    size_t n = rustsecp256k1zkp_v0_11_0_testrand_int(N_MAX + 1);
    size_t n_initial = rustsecp256k1zkp_v0_11_0_testrand_int(n + 1);
...
static void test_schnorrsig_aggregate_unforge(void) {
    ...
    test_schnorrsig_aggregate_input_helper(pubkeys, msgs32, sigs64, n);
    {
        ...
        for (i = 0; i < n + 1; ++i) {
            rustsecp256k1zkp_v0_11_0_testrand256(&aggsig[i*32]);
        }
    ...
    if (n > 0) {
        ...
        size_t k = rustsecp256k1zkp_v0_11_0_testrand_int(n);
        rustsecp256k1zkp_v0_11_0_testrand256(&sigs64[k*64]);
        rustsecp256k1zkp_v0_11_0_testrand256(&sigs64[k*64+32]);
    ...
    if (n > 0) {
        ...
        k = rustsecp256k1zkp_v0_11_0_testrand_int(32*n);
