 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_musig_pubnonce_parse(
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_musig_aggnonce_parse(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_musig_partial_sig_parse(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
 ...
 *
 *  Before aggregating, the pubkeys can be sorted with `rustsecp256k1zkp_v0_11_0_pubkey_sort`
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_musig_pubkey_agg(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
 ...
 *  `rustsecp256k1zkp_v0_11_0_ec_pubkey_tweak_add`.
 *
 ...
 *                        according to `rustsecp256k1zkp_v0_11_0_ec_seckey_verify`, this function
 ...
 *  rustsecp256k1zkp_v0_11_0_musig_pubkey_xonly_tweak_add(..., output_pk, tweak32, keyagg_cache)
 ...
 *                     call to rustsecp256k1zkp_v0_11_0_musig_nonce_gen and must be uniformly random
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_musig_nonce_gen(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
